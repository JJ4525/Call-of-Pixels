    ...
    def map_plot(self, Event = None):
        ...
        for x in range(0,1000,10):
            for y in range(0,1000,10):
                ...
                collist = []
                for collisione in collision:
                    if collisione != p1 and collisione != p2:
                        collist.append(collisione)
                if len(collist) > 1:
                    mappa.itemconfig(a,tags=("grid","obstacle","colored"))
                if game.collision_detection(a,p2) and start <= 12:
                    if start == 12:
                        mappa.itemconfig(a,tags = ("grid","start","colored"))
                    start +=1
                if game.collision_detection(a,p1) and end <= 12:
                    if end == 12:
