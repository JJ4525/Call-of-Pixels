    ...
    class base_game:
        ...
        def map_plot(self, Event = None):
            for x in range(len(self.map_coordinates)):
                ...
                mappa.create_rectangle(m[x][0],m[x][1], fill = m[x][2], tags="mappa_piece")
...
def start_menu(color1,color2,outline_color1,outline_color2,resize,movement_distance1,movement_distance2,health1,health2):
    ...
    build = tk.Label(main, text = "Build 10.0", fg="#bebebe", background="#ffffff")
