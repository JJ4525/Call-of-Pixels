...
def a_star(grid, start, end, buffer_distance=10):
...
class base_game:
    ...
    def move_auto(self,Event = None):
        if self.auto:
            if self.los() and not time.time() - v_p2.start_time < v_p2.reload_speed:
    ...
    def move_auto_toggle(self):
        self.auto = not self.auto
        print(self.auto)
    def sposta(self, Event = None):
        if "Caps_Lock" in self.pulsanti:
            game.move_auto_toggle()
